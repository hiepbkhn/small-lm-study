...
| | K2-Horizon-7B | MiniCPM5-2B | Nanbeige4.2-3B | Spark-X2.5-4B |
|--|--------------|-------------|----------------|---------------|
| Layers | 36 | 42 | 22 × 2 loops | 36 (27 SWA + 9 full) |
| GQA ratio | 4:1 (32/8) | 8:1 (16/2) | 6:1 (48/8) | 4:1 (16/4) |
| head_dim | 128 | 128 | 128 | 256 |
| Context | 512K | 128K | 256K | 1M |
| RoPE θ | 1e7 | 5e6 | 7e7 | 5e6 full / 1e4 sliding |
| Weights (BF16) | ~16.8 GB | ~4.7 GB | ~6.5 GB | ~9 GB |
| KV @ max ctx | 72 GB @ 512K | 5.25 GB @ 128K | 46.9 GB @ 256K | 38.7 GB @ 1M |
| Custom code? | yes (`trust_remote_code`) | no | yes (`trust_remote_code`) | yes (`trust_remote_code`) |
